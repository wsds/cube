...
import underclothes.game.flowers.CanvasSurfaceView;
import underclothes.game.flowers.LocalSettings;
...
public class GlApp extends Activity {
	...
	public void hideNext() {
		...
		canvasSurfaceView.initailizeFlowers();
		canvasSurfaceView.drawFlowers();
		;
	}
